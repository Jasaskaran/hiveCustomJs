console.log("Hive Custom Script V1.6 - ymahendrarajah@alec.ae");
...
var historyPane = `<div id='nfyHistory' class='hide'><div id='nfyHistoryHead' onclick="showHideHistory()" title="Temporarily saved in THIS BROWSER; Available until you clear the cache!!"><span>History</span><span class='icon'></span></div><div id='nfyHistoryBody'></div></div>`;
...
document.getElementById('SelectMain').setAttribute('onclick','selectVisible()');
